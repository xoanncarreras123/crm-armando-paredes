...
import { pct } from "@/presentation/lib/format";
import { useMoney } from "@/presentation/providers/PrefsProvider";
import { IconArrowDown, IconArrowUp, IconClock } from "@/presentation/components/ui/icons";
...
export function MetricsRow() {
  const { metrics: data, loading: isLoading } = usePipeline();
