...
export const MOCK_PROSPECTOS: ProspectoListItem[] = [
...
export const MOCK_DETALLE: Record<string, ProspectoDetalle> = {
  p1: {
    id:"p1", nombre:"Gonzalo Ferreyros", telefono:"+51991234567", email:"gferreyros@gmail.com",
    fuente:"INSTAGRAM", oportunidadId:"o1", etapa:"RESERVA",
    proyecto:{id:"pr1",nombre:"Torre Basadre",distrito:"San Isidro"},
    asesor:{id:"a1",nombre:"Camila Rebaza"},
    score:87,
    scoreExplicacion:"Score muy alto: hipoteca pre-aprobada (+30), visita con su esposa (co-decisora, +25) y respuestas rápidas. El único riesgo es que la pre-aprobación vence en 2 días — cerrar esta semana.",
    scoreHistorial:[20,28,45,52,60,60,87],
    calificacion:{ tipoCompra:"VIVIENDA", presupuesto:700_000, hipotecaPreAprobada:true, hipotecaVenceEl:enDias(2), urgencia:"ALTA", fechaMudanzaEst:enDias(300) },
    contactos:[{ id:"c1", nombre:"María José Ferreyros", relacion:"CONYUGE", telefono:"+51991234568", email:"mjferreyros@gmail.com" }],
    unidadesInteres:[{ id:"u1", numero:"1201", piso:12, area:142.5, precio:685_000, estado:"BLOQUEADO", vista:"PARQUE" }],
    interacciones:[
  ...
  p3: {
    id:"p3", nombre:"Andrés Cáceres", telefono:"+51944556677", email:"acaceres@gmail.com",
    fuente:"REFERIDO", oportunidadId:"o3", etapa:"CALIFICADO",
    proyecto:{id:"pr1",nombre:"Torre Basadre",distrito:"San Isidro"},
    asesor:{id:"a2",nombre:"Rodrigo Velarde"},
    score:41,
    scoreExplicacion:"Score templado en ascenso: ayer preguntó por formas de pago y escrituras (+15) — señal de cierre. Referido por Gonzalo Ferreyros. Aún no tiene financiamiento resuelto.",
    scoreHistorial:[10,15,22,26,30,35,41],
    calificacion:{ tipoCompra:"VIVIENDA", presupuesto:300_000, hipotecaPreAprobada:false, urgencia:"MEDIA", fechaMudanzaEst:enDias(380) },
    contactos:[],
    unidadesInteres:[{ id:"u3", numero:"301", piso:3, area:76, precio:268_000, estado:"DISPONIBLE", vista:"INTERIOR" }],
    interacciones:[
